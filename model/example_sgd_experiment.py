...
sgd = linear_model.SGDClassifier(penalty='elasticnet', class_weight="auto", n_iter=10, verbose=True)
...
sgd = sgd.fit(exp.get_train_np()[0], exp.get_train_np()[1])
print "Training Complete."

# Create evaluation HTML document
exp.eval_model(sgd, "model_results/sgd_example_test.html")
